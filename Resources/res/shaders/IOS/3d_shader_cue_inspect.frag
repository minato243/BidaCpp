...
void main(void)
{
	...
	float ao = u_ao * texture2D(u_mrao_map, v_texture_coord).b;
	...
	for(int i = 0; i < 2; i = i + 1)
	{
		...
		vec3 light_direction = light_direction_1;
		if(i == 1) light_direction = light_direction_2;	
	...
	// vec3 ambient = (diffuse * kD + specular )+ specular * u_ao;
